...
#' @param response_var The name of the response variable column in the data.
#' @param group_vars_vec A character vector specifying the names of the group variable columns in the data.
#' @param plot_qq A logical value indicating whether to plot a QQ plot of the residuals. Default is FALSE.
#' 
#' @return A list of results including:
#' \itemize{
#'   \item{assumptions}{A list containing the residuals from the model and the result of the Anderson-Darling test for normality.}
#'   \item{kruskal_test}{The result of the Kruskal-Wallis test.}
#'   \item{posthoc}{The result of the Dunn's test post-hoc analysis, if applicable.}
#' }
#'
